<x-layouts.app title="Dashboard Pembeli - Koperasi Sipaduhok">
    <section class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary to-secondary px-6 py-8 text-white shadow-xl shadow-primary/15 sm:px-10 sm:py-10">
        ...
        <div class="relative flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a href="{{ route('catalog.index') }}" class="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3 font-bold text-primary transition hover:bg-accent-yellow hover:text-slate-900">
                <i class="fas fa-store" aria-hidden="true"></i> Belanja Sekarang
            </a>
        </div>
    </section>
